                ...
                >
                    {TABS.map((tab) => (
                        <button
                            ...
                            data-id={tab.label}
                            type='button'
                            // className='inline-flex h-9 w-9 items-center justify-center text-black dark:text-white transition-colors duration-100 focus-visible:outline-2 dark:data-[checked=true]:text-teal-600'
