    ...
    return <div className="static max-w-[700px] z-20">
        ...
        <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
                <TextDecodeAnimation hindiText="वैभव म्हस्के" englishText="Vaibhav Mhaske" style="text-3xl text-center font-semibold tracking-wider transition-all duration-300 ease-in-out" />
        ...
        <div className="mt-5">
            ...
            <li className="flex flex-wrap gap-10 mt-[37px] text-slate-500 dark:text-slate-400">
                ...
                <a href="https://x.com/code_vaibhav" className="flex gap-2 items-center hover:scale-125">
                ...
                <a href="https://www.linkedin.com/in/vaibhavmhaske/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="flex gap-2 items-center hover:scale-125">
                ...
                <a href="mailto:vaibhavmhaske.here@gmail.com" className="flex gap-2 items-center hover:scale-125">
